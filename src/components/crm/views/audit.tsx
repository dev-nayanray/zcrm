...
type Log = { id: string; userId?: string | null; action: string; entity: string; entityId?: string | null; changes?: any; ipAddress?: string | null; createdAt: string; user?: { id: string; name: string; email: string } | null };
  ...
  return (
    <div>
      ...
      <DataTable<Log>
        ...
        columns={[
          { key: "time", header: "Time", render: (r) => <span className="text-xs">{formatDate(r.createdAt)}</span> },
